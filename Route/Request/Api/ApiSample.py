...
class CApiSample(CBaseRequest):
    def __init__(self):
        ...
        super().__init__(path="/api/sample", method="POST", name="Api Sample", request_model=Model.ModelSample, response_model=Success.SuccessSample, tags=["샘플", "태그는 1개 이상 가능하다."]
                        ,description="API 샘플용이다.\n설명글이다 핳핳핳핳.")
